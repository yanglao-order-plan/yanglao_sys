...
import { 
  createUserDataApi, deleteUserDataApi, updateUserDataApi, getUserDataApi,
} from "@/api/manage"
import { type IGetUserData } from "@/api/manage/types/user"
...
//#region 删
const handleDelete = (row: IGetUserData) => {
