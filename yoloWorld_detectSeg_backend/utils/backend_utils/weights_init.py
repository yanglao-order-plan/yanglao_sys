...
def init_Sample_weights():
    with app.app_context():
        Sample_yolov5n_300_epochs = WeightModel(weights_name='Sample_yolov5n_300_epochs',
                                                weights_relative_path='weights/yolov5-6.2/Sample_yolov5n_300_epochs.pt',
                                                weights_version='yolov5-6.2',
                                                dataset_id=2)
        Sample_yolov5s_300_epochs = WeightModel(weights_name='Sample_yolov5s_300_epochs',
                                                weights_relative_path='weights/yolov5-6.2/Sample_yolov5s_300_epochs.pt',
                                                weights_version='yolov5-6.2',
                                                dataset_id=2)
        Sample_yolov5l_300_epochs = WeightModel(weights_name='Sample_yolov5l_300_epochs',
                                                weights_relative_path='weights/yolov5-6.2/Sample_yolov5l_300_epochs.pt',
                                                weights_version='yolov5-6.2',
                                                dataset_id=2)
        Sample_yolov5m_300_epochs = WeightModel(weights_name='Sample_yolov5m_300_epochs',
                                                weights_relative_path='weights/yolov5-6.2/Sample_yolov5m_300_epochs.pt',
                                                weights_version='yolov5-6.2',
                                                dataset_id=2)
        Sample_yolov5x_300_epochs = WeightModel(weights_name='Sample_yolov5x_300_epochs',
                                                weights_relative_path='weights/yolov5-6.2/Sample_yolov5x_300_epochs.pt',
                                                weights_version='yolov5-6.2',
                                                dataset_id=2)
        Sample_yolov5n6_300_epochs = WeightModel(weights_name='Sample_yolov5n6_300_epochs',
                                                 weights_relative_path='weights/yolov5-6.2/Sample_yolov5n6_300_epochs.pt',
                                                 weights_version='yolov5-6.2',
                                                 dataset_id=2)
        Sample_yolov5s6_300_epochs = WeightModel(weights_name='Sample_yolov5s6_300_epochs',
                                                 weights_relative_path='weights/yolov5-6.2/Sample_yolov5s6_300_epochs.pt',
                                                 weights_version='yolov5-6.2',
                                                 enable=True,
                                                 dataset_id=2)
        Sample_yolov5l6_300_epochs = WeightModel(weights_name='Sample_yolov5l6_300_epochs',
                                                 weights_relative_path='weights/yolov5-6.2/Sample_yolov5l6_300_epochs.pt',
                                                 weights_version='yolov5-6.2',
                                                 dataset_id=2)
        Sample_yolov5m6_300_epochs = WeightModel(weights_name='Sample_yolov5m6_300_epochs',
                                                 weights_relative_path='weights/yolov5-6.2/Sample_yolov5m6_300_epochs.pt',
                                                 weights_version='yolov5-6.2',
                                                 dataset_id=2)
        Sample_yolov5x6_300_epochs = WeightModel(weights_name='Sample_yolov5x6_300_epochs',
...
def init_TACO_weights():
    with app.app_context():
        TACO_yolov5s_300_epochs = WeightModel(weights_name='TACO_yolov5s_300_epochs',
                                              weights_relative_path='weights/yolov5-3.1/TACO_yolov5s_300_epochs.pt',
                                              weights_version='yolov5-3.1',
                                              enable=True,
                                              dataset_id=3)
        TACO_yolov5l_300_epochs = WeightModel(weights_name='TACO_yolov5l_300_epochs',
                                              weights_relative_path='weights/yolov5-3.1/TACO_yolov5l_300_epochs.pt',
                                              weights_version='yolov5-3.1',
                                              dataset_id=3)
        TACO_yolov5m_300_epochs = WeightModel(weights_name='TACO_yolov5m_300_epochs',
                                              weights_relative_path='weights/yolov5-3.1/TACO_yolov5m_300_epochs.pt',
                                              weights_version='yolov5-3.1',
                                              dataset_id=3)
        TACO_yolov5x_300_epochs = WeightModel(weights_name='TACO_yolov5x_300_epochs',
...
def init_Garbage_weights():
    with app.app_context():
        Garbage_yolov5s_300_epochs = WeightModel(weights_name='Garbage_yolov5s_300_epochs',
                                                 weights_relative_path='weights/yolov5-3.1/Garbage_yolov5s_300_epochs.pt',
                                                 weights_version='yolov5-3.1',
                                                 enable=True,
                                                 dataset_id=4)
        Garbage_yolov5l_300_epochs = WeightModel(weights_name='Garbage_yolov5l_300_epochs',
                                                 weights_relative_path='weights/yolov5-3.1/Garbage_yolov5s_300_epochs.pt',
                                                 weights_version='yolov5-3.1',
                                                 dataset_id=4)
        Garbage_yolov5m_300_epochs = WeightModel(weights_name='Garbage_yolov5m_300_epochs',
                                                 weights_relative_path='weights/yolov5-3.1/Garbage_yolov5s_300_epochs.pt',
                                                 weights_version='yolov5-3.1',
                                                 dataset_id=4)
        Garbage_yolov5x_300_epochs = WeightModel(weights_name='Garbage_yolov5x_300_epochs',
                                                 weights_relative_path='weights/yolov5-3.1/Garbage_yolov5s_300_epochs.pt',
                                                 weights_version='yolov5-3.1',
                                                 dataset_id=4)
