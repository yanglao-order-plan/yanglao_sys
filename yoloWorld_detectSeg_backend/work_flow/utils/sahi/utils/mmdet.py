...
class MmdetTestConstants:
    ...
    MMDET_CASCADEMASKRCNN_MODEL_PATH = "tests/data/flows/mmdet/cascade_mask_rcnn/cascade_mask_rcnn_r50_fpn_1x_coco_20200203-9d4dcb24.pth"
    ...
    MMDET_RETINANET_MODEL_PATH = "tests/data/flows/mmdet/retinanet/retinanet_r50_fpn_2x_coco_20200131-fdb43119.pth"
    ...
    MMDET_YOLOX_TINY_MODEL_PATH = "tests/data/flows/mmdet/yolox/yolox_tiny_8x8_300e_coco_20211124_171234-b4047906.pth"

    MMDET_CASCADEMASKRCNN_CONFIG_PATH = "tests/data/flows/mmdet/cascade_mask_rcnn/cascade-mask-rcnn_r50_fpn_1x_coco.py"
    MMDET_RETINANET_CONFIG_PATH = (
        "tests/data/flows/mmdet/retinanet/retinanet_r50_fpn_1x_coco.py"
    )
    MMDET_YOLOX_TINY_CONFIG_PATH = (
        "tests/data/flows/mmdet/yolox/yolox_tiny_8xb8-300e_coco.py"
    )
