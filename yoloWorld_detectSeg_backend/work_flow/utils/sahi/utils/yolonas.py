...
class YoloNasTestConstants:
    ...
    YOLONAS_S_MODEL_PATH = "tests/data/flows/yolonas/yolo_nas_s_coco.pt"

    YOLONAS_M_MODEL_URL = "https://sghub.deci.ai/models/yolo_nas_m_coco.pth"
    YOLONAS_M_MODEL_PATH = "tests/data/flows/yolonas/yolo_nas_m_coco.pt"

    YOLONAS_L_MODEL_URL = "https://sghub.deci.ai/models/yolo_nas_l_coco.pth"
    YOLONAS_L_MODEL_PATH = "tests/data/flows/yolonas/yolo_nas_l_coco.pt"
