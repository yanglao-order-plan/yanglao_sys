...
from work_flow.engines import OnnxBaseModel
import logging
...
class ChineseClipONNX:
    ...
    def tokenize(self, texts, context_length=52):
        ...
        context_length : int
            The context length to use; all baseline flows use 52 as the context length
        Returns
        -------
...
def default_vocab():
    ...
    try:
       ...
       logging.error(f"Error loading default vocab: {e}")
...
class BasicTokenizer(object):
    ...
    def tokenize(self, text):
        ...
        # flows. This is also applied to the English flows now, but it doesn't
        # matter since the English flows were not trained on any Chinese data
